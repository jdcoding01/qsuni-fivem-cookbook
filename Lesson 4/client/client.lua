...
RegisterCommand('imhungry', function()
    TriggerEvent('ap_uber_eats:client:RequestMenu')
end, false)

RegisterNetEvent("ap_uber_eats:client:RequestMenu", function()
    TriggerServerEvent("ap_uber_eats:server:RequestMenu")
end)

RegisterNetEvent("ap_uber_eats:client:OpenMenu", function(data)
    SetNuiFocus(true, true)
    SendNUIMessage(data)
   
end)

RegisterNUICallback("PlaceOrder", function(data)
    
    SetNuiFocus(false, false)
    TriggerServerEvent("ap_uber_eats:server:PlaceOrder", {
